...
-- 2021-02-27,Daehoon Kim,Created File
-- 2021-02-27,Daehoon Kim,Completed Questions 1-5
-- 2021-02-28,Daehoon Kim,Completed Questions 6-8
-- 2021-02-28,Daehoon Kim,included "IIF" Statement in question 6 before the lag statement
-- 2021-02-28,Daehoon Kim,Added "Top 100000" in the Select Statement and included the "Order By"in the View Definition
-- 2021-02-28,Daehoon Kim,Formatted Code to align properly 

--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DaehoonKim')
	 Begin 
	  Alter Database [Assignment07DB_DaehoonKim] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DaehoonKim;
	 End
	Create Database Assignment07DB_DaehoonKim;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DaehoonKim;
...
Select Top 100000000 
 ...
 [PreviousMonthCount] = IIF(Month(InventoryDate)=1,0, Lag (InventoryCount) Over (Order By ProductName, Month([InventoryDate])))
